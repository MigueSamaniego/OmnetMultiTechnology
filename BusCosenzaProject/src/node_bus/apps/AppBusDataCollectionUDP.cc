...
bool AppBusDataCollectionUDP::initialized = false;
...
std::string AppBusDataCollectionUDP::buildDataString(const std::vector<double>& values)
{
...
Define_Module(AppBusDataCollectionUDP);
...
void AppBusDataCollectionUDP::initialize(int stage)
{
...
// ----------------------------------------------------------------------
void AppBusDataCollectionUDP::receiveSignal(cComponent *source, simsignal_t signalID, long l, cObject *details)
{
...
bool AppBusDataCollectionUDP::startApplication()
{
...
bool AppBusDataCollectionUDP::stopApplication()
{
    if (Control_Task_Timer) {
...
void AppBusDataCollectionUDP::finish()
{
...
void AppBusDataCollectionUDP::processPacket(std::shared_ptr<inet::Packet> pk)
{
...
void AppBusDataCollectionUDP::subscriptionSignalState(){
...
void AppBusDataCollectionUDP::sendDataToCloud(){
...
inet::Coord AppBusDataCollectionUDP::convertXYtoLatLon(inet::Coord pos)
{
