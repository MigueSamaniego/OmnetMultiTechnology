    ...
    if(Vehicle_With_Interface){
        ...
        if (outputBuffer.isEmpty()) {
            ...
            //while(packet_lose){
                ...
                if (outputBuffer.isEmpty()) {
                    EV_ERROR << "socket WIFI OK4.4: "<< endl;
                    ...
                    if(data_priority_on_sd >= 20){
                        if(Strategy_Switching == 1){
                            ...
                            auto batch = sdcard.popBatch(20, deadline_start, deadline_until, 1);// LTE
                            if(!batch.empty())
                                outputBuffer.load(batch);
                        }else if(Strategy_Switching == 3){
                            auto batch = sdcard.popBatch(20, deadline_start, deadline_until, ConnectionToAP);
                        ...
                        if(Strategy_Switching == 1){
                            ...
                            auto batch1 = sdcard.popBatch(20, deadline_start, deadline_until, ConnectionToAP);// AQUI EL DEADLINE ES CONSIDERATO IMPORTANTE!!!!
                            if(!batch1.empty())
                                outputBuffer.load(batch1);
                        }else if(Strategy_Switching == 4){
                            auto batch1 = sdcard.popBatch(20, deadline_start, deadline_until, 1);// PIDE TODOS LOS DATOS SIN IMPORTAR DEADLINE o tecnologia a usar
                ...
                }else{// mientras tenga datos en el buffer
