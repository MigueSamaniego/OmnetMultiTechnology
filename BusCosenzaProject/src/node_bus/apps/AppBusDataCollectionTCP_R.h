...
// INCLUDIN STRUCTURE TO TCP PACKETS
#include "inet/transportlayer/contract/tcp/TcpSocket.h"


//
class VEINS_INET_API AppBusDataCollectionTCP_R : public veins::VeinsInetApplicationBase, public omnetpp::cListener, public inet::TcpSocket::ICallback {
protected:

    // object to handle the connetions TCP
...
protected:
    ...
    // ** MODIFICAR: Agregar finish() para deseas desuscribirte explícitamente **
