...
//
class VEINS_INET_API AppBusTCP_R_StateM_B : public veins::VeinsInetApplicationBase, public omnetpp::cListener, public inet::TcpSocket::ICallback {
protected:
