...
#ifndef __INET_IEEE80211MACM_H
#define __INET_IEEE80211MACM_H
 ...
 */
class INET_API Ieee80211MacM : public MacProtocolBase
{
  public:
     static simsignal_t Associated_state;
     //static simsignal_t getAssociatedStateSignal() { return Associated_state; }
