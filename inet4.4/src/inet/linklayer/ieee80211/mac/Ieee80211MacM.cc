...
Define_Module(Ieee80211MacM);

Ieee80211MacM::Ieee80211MacM()
{
    //Associated_state = registerSignal("Associated_state");
}
...
simsignal_t Ieee80211MacM::Associated_state = registerSignal("Associated_state");

void Ieee80211MacM::initialize(int stage)
{
...
void Ieee80211MacM::initializeRadioMode() {
...
const MacAddress& Ieee80211MacM::isInterfaceRegistered()
{
//    if (!par("multiMac"))
...
void Ieee80211MacM::configureNetworkInterface()
{
...
void Ieee80211MacM::handleMessageWhenUp(cMessage *message)
{
...
void Ieee80211MacM::handleSelfMessage(cMessage *msg)
{
    ASSERT(false);
}

void Ieee80211MacM::handleMgmtPacket(Packet *packet)
{
...
void Ieee80211MacM::handleUpperPacket(Packet *packet)
{
...
void Ieee80211MacM::handleLowerPacket(Packet *packet)
{
...
void Ieee80211MacM::handleUpperCommand(cMessage *msg)
{
...
void Ieee80211MacM::encapsulate(Packet *packet)
{
...
void Ieee80211MacM::decapsulate(Packet *packet)
{
...
void Ieee80211MacM::receiveSignal(cComponent *source, simsignal_t signalID, intval_t value, cObject *details)
{
...
void Ieee80211MacM::configureRadioMode(IRadio::RadioMode radioMode)
{
...
void Ieee80211MacM::sendUp(cMessage *msg)
{
...
void Ieee80211MacM::sendUpFrame(Packet *frame)
{
...
void Ieee80211MacM::sendDownFrame(Packet *frame)
{
...
void Ieee80211MacM::sendDownPendingRadioConfigMsg()
{
    if (pendingRadioConfigMsg != nullptr) {
...
void Ieee80211MacM::processUpperFrame(Packet *packet, const Ptr<const Ieee80211DataOrMgmtHeader>& header)
{
...
void Ieee80211MacM::processLowerFrame(Packet *packet, const Ptr<const Ieee80211MacHeader>& header)
{
...
// FIXME
void Ieee80211MacM::handleStartOperation(LifecycleOperation *operation)
{
    if (!operation)
...
// FIXME
void Ieee80211MacM::handleStopOperation(LifecycleOperation *operation)
{
}

// FIXME
void Ieee80211MacM::handleCrashOperation(LifecycleOperation *operation)
{
}
